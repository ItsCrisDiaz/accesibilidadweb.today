(function () {
  ...
  let embed = document.querySelector("#newsletter");
  if (!embed) return;
  ...
  const email = embed.querySelector("input");
  const loading = embed.querySelector(".loader");
  const error = embed.querySelector("[data-form-error]");
  const announce = embed.querySelector("[data-form-state]");
